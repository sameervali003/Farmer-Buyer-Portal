...
const ProductCard = ({ description, type, owner, file, price, id }) => {
    ...
    return (
        ...
        <div className="flex justify-between items-center">
            ...
            <button type="button" onClick={borrow} class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-3 py-2 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Borrow</button>
        </div>
    </div>
</div>
